  ...
  if (props.color === "sky") {
    return (
      <div className="flex flex-col items-center">
        <div className="rounded-[50%] bg-sky-400/80 p-4 m-3 ring-[6px] ring-sky-700 hover:bg-sky-300">
          <svg className="h-32 w-32 scale-75 hover:transition duration-200 hover:scale-[80%]">
            {props.icon}
          </svg>
        </div>
        <p className="my-2 font-bold text-4xl text-sky-400">{props.count}+</p>
        <p className="font-semibold text-sky-400 text-xl">{props.text}</p>
      </div>
    );
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        <p className="my-2 font-bold text-4xl text-emerald-300">
          {props.count}+
        </p>
