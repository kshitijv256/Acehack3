...
const GetInvolved = () => {
  return (
    <div className="relative items-center justify-center bg-gradient-to-br from-gray-900 via-purple-950 to-gray-900 backdrop-blur-lg w-full z-20 py-10 scroll-smooth">
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <QrBox
            image={cp}
            name="Call for Community Partner"
            role={
                <a
